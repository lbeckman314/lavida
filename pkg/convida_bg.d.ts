...
export function universe_set_size(a: number, b: number, c: number): number;
...
export function universe_cells_from_pattern(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
